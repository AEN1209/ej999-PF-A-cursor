...
async function testSmallCsvFile() {
    ...
    assert_1.default.strictEqual(records.length, 3, 'Should have 3 aggregated records'); // 2022-12, 2023-01, 2023-02
    const rec2022_12 = records.find((r) => r.year === '2022' && r.month === '12');
    assert_1.default.ok(rec2022_12, 'Record for 2022-12 should exist');
    assert_1.default.strictEqual(rec2022_12.numberOfSales, '1');
    assert_1.default.strictEqual(rec2022_12.maxTotal, '50.00');
    assert_1.default.strictEqual(rec2022_12.minTotal, '50.00');
    assert_1.default.strictEqual(rec2022_12.averageTotal, '50.00');
    assert_1.default.strictEqual(rec2022_12.standardDeviation, '0.00');
    const rec2023_01 = records.find((r) => r.year === '2023' && r.month === '1');
    assert_1.default.ok(rec2023_01, 'Record for 2023-01 should exist');
    assert_1.default.strictEqual(rec2023_01.numberOfSales, '3');
    assert_1.default.strictEqual(rec2023_01.maxTotal, '300.00');
    assert_1.default.strictEqual(rec2023_01.minTotal, '100.00');
    assert_1.default.strictEqual(rec2023_01.averageTotal, '200.00');
    assert_1.default.strictEqual(rec2023_01.standardDeviation, '81.65');
    const rec2023_02 = records.find((r) => r.year === '2023' && r.month === '2');
    assert_1.default.ok(rec2023_02, 'Record for 2023-02 should exist');
    assert_1.default.strictEqual(rec2023_02.numberOfSales, '2');
    assert_1.default.strictEqual(rec2023_02.maxTotal, '250.00');
    assert_1.default.strictEqual(rec2023_02.minTotal, '150.00');
    assert_1.default.strictEqual(rec2023_02.averageTotal, '200.00');
    assert_1.default.strictEqual(rec2023_02.standardDeviation, '50.00');
}
async function testEmptyCsvFile() {
    ...
    assert_1.default.strictEqual(records.length, 0, 'Should have 0 aggregated records for empty file');
}
async function testSameYearMonthRecords() {
    ...
    assert_1.default.strictEqual(records.length, 1, 'Should have 1 aggregated record for same year/month');
    const rec2023_01 = records.find((r) => r.year === '2023' && r.month === '1');
    assert_1.default.ok(rec2023_01, 'Record for 2023-01 should exist');
    assert_1.default.strictEqual(rec2023_01.numberOfSales, '3');
    assert_1.default.strictEqual(rec2023_01.maxTotal, '300.00');
...
async function testSingleRecord() {
    ...
    assert_1.default.strictEqual(records.length, 1, 'Should have 1 aggregated record for single record');
    const rec2023_01 = records.find((r) => r.year === '2023' && r.month === '1');
    assert_1.default.ok(rec2023_01, 'Record for 2023-01 should exist');
    assert_1.default.strictEqual(rec2023_01.numberOfSales, '1');
    assert_1.default.strictEqual(rec2023_01.maxTotal, '100.00');
    assert_1.default.strictEqual(rec2023_01.minTotal, '100.00');
    assert_1.default.strictEqual(rec2023_01.averageTotal, '100.00');
    assert_1.default.strictEqual(rec2023_01.standardDeviation, '0.00');
}
async function main() {
